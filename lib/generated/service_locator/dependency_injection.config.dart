...
import '../../core/platform/network_status.dart' as _i20;
...
import '../../features/auth/sign_in/domain/repositories/auth_repository.dart'
    as _i22;
import '../../features/auth/sign_in/domain/usecases/auth_use_case.dart' as _i24;
...
import '../../utils/mock/mock_teacher_reviews.dart' as _i17;
import '../../utils/mock/mock_teachers.dart' as _i18;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i17.MockTeacherReviews>(() => _i17.MockTeacherReviews());
  gh.lazySingleton<_i18.MockTeachers>(() => _i18.MockTeachers());
  gh.lazySingleton<_i19.MockTransactions>(() => _i19.MockTransactions());
  gh.factory<_i20.NetworkStatus>(() => _i20.NetworkStatusImp());
  gh.factory<_i21.SettingsPageProvider>(() => _i21.SettingsPageProvider());
  gh.lazySingleton<_i22.AuthRepository>(() => _i23.AuthRepositoryImp(
        dataSource: get<_i6.AuthRemoteDataSource>(),
        networkStatus: get<_i20.NetworkStatus>(),
      ));
  gh.lazySingleton<_i24.AuthUseCase>(
      () => _i24.AuthUseCase(get<_i22.AuthRepository>()));
  gh.lazySingleton<_i25.ForgotPasswordRepository>(
      () => _i26.ForgotPasswordRepositoryImp(
            get<_i8.ForgotPasswordDataSource>(),
            get<_i20.NetworkStatus>(),
          ));
  gh.lazySingleton<_i27.ForgotPasswordUseCase>(
      () => _i27.ForgotPasswordUseCase(get<_i25.ForgotPasswordRepository>()));
  gh.lazySingleton<_i28.GetRecommendedLessonsRepository>(
      () => _i29.GetRecommendedLessonsRepositoryImp(
            get<_i10.GetRecommendedLessonsDataSource>(),
            get<_i20.NetworkStatus>(),
          ));
  gh.lazySingleton<_i30.GetRecommendedLessonsUseCase>(() =>
      _i30.GetRecommendedLessonsUseCase(
          get<_i28.GetRecommendedLessonsRepository>()));
  gh.lazySingleton<_i31.GetTopTeachersRepository>(
      () => _i32.GetTopTeachersRepositoryImp(
            get<_i11.GetTopTeachersDataSource>(),
            get<_i20.NetworkStatus>(),
          ));
  gh.lazySingleton<_i33.GetTopTeachersUseCase>(
      () => _i33.GetTopTeachersUseCase(get<_i31.GetTopTeachersRepository>()));
  gh.factory<_i34.SignInStore>(() => _i34.SignInStore(get<_i24.AuthUseCase>()));
  gh.factory<_i35.SignUpStore>(() => _i35.SignUpStore(get<_i24.AuthUseCase>()));
  gh.factory<_i36.GetRecommendedLessonsStore>(() =>
      _i36.GetRecommendedLessonsStore(
          get<_i30.GetRecommendedLessonsUseCase>()));
  gh.factory<_i37.GetTopTeachersStore>(
      () => _i37.GetTopTeachersStore(get<_i33.GetTopTeachersUseCase>()));
  return get;
}
