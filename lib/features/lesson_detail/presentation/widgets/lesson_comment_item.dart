...
class LessonCommentItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        InkWell(
          splashColor: AppColors.neutral.shade500,
          onTap: replyOnTab,
          child: Padding(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Joseph Gonzalez • ${AppFormats.instance.timeAgo(comment.commentAt)}",
                      ...
                      Text(
                        "This is a test comment on specific lesson! Test for UI, overflow, multiple lines,...",
